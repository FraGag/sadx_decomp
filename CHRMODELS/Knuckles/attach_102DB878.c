...
static struct Vector3 vec3_102DB7B8[] =
{
...
static struct Vector3 vec3_102DB818[] =
{
...
static short unsigned int strips_102DB740[] =
{
    10,
    5, 3, 1, 2, 0, 6, 4, 7, 5, 3,
    4,
...
static struct MESH mesh_102DB798[] =
{
    { 0 | MeshPolyType_StripsB, 2, strips_102DB740, 0, NULL, NULL, uv_102DB760, 0 }
};

static struct MATERIAL mat_102DB72C[] =
{
    {
        0xFFB2B2B2,
        0x00FFFFFF,
...
struct ATTACH attach_102DB878 =
{
    vec3_102DB7B8,
    vec3_102DB818,
    ARRAYSIZE(vec3_102DB7B8),
    mesh_102DB798,
    mat_102DB72C,
    ARRAYSIZE(mesh_102DB798),
    ARRAYSIZE(mat_102DB72C),
